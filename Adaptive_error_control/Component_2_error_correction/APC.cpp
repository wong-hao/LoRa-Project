...
int main()
{
    ...
    if(strcmp(choice, "PC")==0){
        ...
        */
        ...
        char Binarystring6[BUF_SIZE] = { 0 }; //APC candidate

        LeastReliableMask(Binarystring1, Binarystring2, Binarystring3, Binarystring4, Binarystring5);
        majorityVoting(Binarystring1, Binarystring2, Binarystring3, Binarystring4, Binarystring6);

        int Hamming_weight_now = 0;
        for(int loopcount = 0; loopcount<= strlen(Binarystring5)-1; loopcount++){
            if(Binarystring5[loopcount] == '1'){
                Hamming_weight_now++;
            }
        }
        ...
        */
        ...
        compareCRC(crc_int, Binarystring6, realresult, size, pass_crc);
