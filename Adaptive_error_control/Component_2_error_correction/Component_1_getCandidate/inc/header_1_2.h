...
#define Concurrent 1         //�������ͨ��crcУ��Ĵ���
#define Hamming_weight_max 256 * 8//deprecated because of infinite RAM and latency constrain
#define MAXLATENCY 0.218           //computation overhead  (confirmed: RECEIVE_DELAY1 > Lantency + TOA / RECEIVE_DELAY2��Ϊ����)�� �����������ֳ�����stage��ϵ�����: ���Ϳռ�ʱ�临�Ӷ�
#define MICOption 1//�Ƿ����MICУ��
